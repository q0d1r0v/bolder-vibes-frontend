...
export type HeroWaveProps = {
  ...
  bgOnly?: boolean; // render only the wave background, no UI
};

export function HeroWave({ className, style, extendLeftPx = 320, title = "Describe. Build. Ship.", subtitle = "Turn your ideas into full-stack apps with AI — just chat, watch it code, and preview live.", placeholder = "Describe what you want to create...", buttonText = "Generate", onPromptSubmit, bgOnly = false }: HeroWaveProps) {
  ...
  const suggestionsRef = useRef<string[]>([
    ...
    " social network with posts and messaging",
    " fitness tracker with workout plans",
    " online learning platform with quizzes",
    " food delivery app with restaurant listings",
    " productivity dashboard with tasks and notes",
    " finance app with budget tracking",
  ]);
  ...
  useEffect(() => {
    ...
    waveRenderer.setClearColor(0x000000, 100);
              ...
              >
                <div className="relative w-full sm:w-[720px]">
                  ...
                  <button
                    ...
                    className="absolute right-3 bottom-3 inline-flex items-center justify-center w-10 h-10 rounded-xl bg-white/[0.12] text-white hover:bg-white/[0.2] transition-colors"
                  >
